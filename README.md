# EchoDrive Carla Project Scripts

This repository contains the scripts and files for our EchoDrive project.
...
2.## Clone this Repository and all the files into your CARLA 0.9.13 root folder
